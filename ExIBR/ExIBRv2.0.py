...
def test_IBR(learning_rate=1, batch_size=100, epoch_time=20, max_patience=3):
    ...
    for y in [20]:# #20 is best,10 20 30 40 50
        for beta in [0.9]:#0.8 is best
            for alpha in [0]:#best is 0.05
