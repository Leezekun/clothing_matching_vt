...
my_matrix_text_bottom = numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/features_text/bottom_feature.txt","r"),delimiter=",",skiprows=0)
print ('bottom shape')
...
print   ('now():'+str( datetime.now() ))
my_matrix_text_top = numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/features_text/top_feature.txt","r"),delimiter=",",skiprows=0)
...
print ('loading ids...')
print ('now():'+str( datetime.now()))
top_id_list = numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/features_text/cate_top_id_list.txt","r"),delimiter=" ",skiprows=0)
bottom_id_list = numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/features_text/cate_bottom_id_list.txt","r"),delimiter=" ",skiprows=0)
...
print   ('now():'+str( datetime.now() ))
ijk_list=numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/pkl/train_ijk_shuffled_811.txt","r"),delimiter="\t",skiprows=0)
...
write_file=open('/storage/songxuemeng/dataset_backup/filter_dataset/pkl/AUC_new_dataset_unified_text_train8110.pkl','wb')
...
print   ('now():'+str( datetime.now() ))
ijk_list=numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/pkl/valid_ijk_shuffled_811.txt","r"),delimiter="\t",skiprows=0)
...
write_file=open('/storage/songxuemeng/dataset_backup/filter_dataset/pkl/AUC_new_dataset_unified_text_valid8110.pkl','wb')
# cPickle.dump将train数据放入pkl文件，其中train又包含三个矩阵，第一个为top的feature,第二个为和top相搭配的bottom feature，
# 第三个为随意搭配的bottom feature.
...
print   ('now():'+str( datetime.now() ))
ijk_list=numpy.loadtxt(open("/storage/songxuemeng/dataset_backup/filter_dataset/pkl/test_ijk_shuffled_811.txt","r"),delimiter="\t",skiprows=0)
...
write_file=open('/storage/songxuemeng/dataset_backup/filter_dataset/pkl/AUC_new_dataset_unified_text_test8110.pkl','wb')
# cPickle.dump将train数据放入pkl文件，其中train又包含三个矩阵，第一个为top的feature,第二个为和top相搭配的bottom feature，
# 第三个为随意搭配的bottom feature.
