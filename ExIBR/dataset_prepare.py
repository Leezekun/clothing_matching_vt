...
f0=open('/storage/songxuemeng/lizekun/ExIBR/unique_newdataset_top_bottom_valid_pairs_shufflelist.txt','w')
f1=open('/storage/songxuemeng/lizekun/ExIBR/total_ijk_shuffled_811.txt','w')
f2=open('/storage/songxuemeng/lizekun/ExIBR/total_ijk_811.txt','w')
f3=open('/storage/songxuemeng/lizekun/ExIBR/train_ijk_shuffled_811.txt','w')
f4=open('/storage/songxuemeng/lizekun/ExIBR/valid_ijk_shuffled_811.txt','w')
f5=open('/storage/songxuemeng/lizekun/ExIBR/test_ijk_shuffled_811.txt','w')
...
print   ('now():'+ str( datetime.now() ))
write_file=open('/storage/songxuemeng/lizekun/ExIBR/AUC_new_dataset_train_811.pkl','wb')
...
print 'writing valid'
print   ('now():'+ str( datetime.now() ))
write_file=open('/storage/songxuemeng/lizekun/ExIBR/AUC_new_dataset_valid_811.pkl','wb')
# cPickle.dump将train数据放入pkl文件，其中train又包含三个矩阵，第一个为top的feature,第二个为和top相搭配的bottom feature，
# 第三个为随意搭配的bottom feature.
...
print 'writing test'
print   ('now():'+ str( datetime.now() ))
write_file=open('/storage/songxuemeng/lizekun/ExIBR/AUC_new_dataset_test_811.pkl','wb')
# cPickle.dump将train数据放入pkl文件，其中train又包含三个矩阵，第一个为top的feature,第二个为和top相搭配的bottom feature，
# 第三个为随意搭配的bottom feature.
