...
f2=open('/storage/songxuemeng/lizekun/ExIBR/total_ijk_811_noshuffle.txt','w')
f3=open('/storage/songxuemeng/lizekun/ExIBR/train_ijk_811_noshuffle.txt','w')
f4=open('/storage/songxuemeng/lizekun/ExIBR/valid_ijk_811_noshuffle.txt','w')
f5=open('/storage/songxuemeng/lizekun/ExIBR/test_ijk_811_noshuffle.txt','w')
...
count = 0
for i in range (0, len(top_bottom_list)):
    if count % 2000 == 0:
